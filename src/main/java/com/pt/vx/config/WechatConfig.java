...
public class WechatConfig {
     ...
     * appId
     */
    public static final String VxAppId = "wxabc1d70ac3feeb30";

    /**
     * 你的微信的密钥
     * appSecret
     */
    public static final String VxAppSecret = "904765317b2b831dabbbf04089cc6a43";
    ...
    static {
        userList.add(getUser(
                "o7qy96Nkb5u-coMLwJStE-Omvefo", //扫码关注你的测试号以后，测试平台会出现TA的微信号
                "z6flGGUHMhIEsjrUVWes-yuFOuWPJh32sGiNVTke1uY", //要给这个人发送的模板ID
                "tp", //咋称呼这个人
                "山东省青岛市黄岛区", //这个人的详细地址
                "青岛", //这个人在的城市
                new BirthDay(2002,10,23,false,false,"宝宝生日快乐！！"),
                new BirthDay(2002,3,22,false,false,"骏骏生日快乐哦~~"),
                new BirthDay(2021,10,12,false,false),
                new BirthDay(2021,10,12,false,true,"周年快乐！！！")
        ));

        userList.add(getUser(
                "o7qy96OHY42NwPuS4UFmvqTSafck",
                "z6flGGUHMhIEsjrUVWes-yuFOuWPJh32sGiNVTke1uY", //要给这个人发送的模板ID
                "lcjunjun",
                "天津市津南区",
                "天津",
